...
[사용법]
python migrate_eval_results.py <model_name> [--storage-dir DIR] [--keys KEY1 KEY2]
"""
...
def run():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="특정 키만 처리 (공백 구분, 예: --keys SOCCHIP-102 SOCIP-742)",
    )
    parser.add_argument(
        "--keys-file",
        default=None,
