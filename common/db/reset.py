"""평가 결과 테이블 리셋 (eval_task_result* 자식 4 → 부모 1 순 삭제).
...
[필터 조건]
- eval_rule_set_id 기준 (필수)
- 옵션: model_name / created_by

[안전장치]
- 기본은 dry-run, execute=True를 명시해야 실제 삭제
- 실제 삭제 전 사용자 확인 입력 필요 ("DELETE")
"""
